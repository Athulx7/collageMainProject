...
public class ViewFuelStation extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.view_fuel_stations_user, container, false);

        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(getActivity());


        listView = root.findViewById(R.id.user_fuelStation_View);
    ...
    public void getUserFuelStation() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.SERVERUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    Toast.makeText(getContext(), "No Fuel Stations Available", Toast.LENGTH_LONG).show();
                }
            }
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("key", "getFuelStationUser");
                map.put("p_lid", uid);
