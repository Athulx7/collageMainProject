...
public class RequestAdapterServiceCenter extends ArrayAdapter<RequestPojo> {
    Activity context;
    List<RequestPojo> rest_List;

    public RequestAdapterServiceCenter(Activity context, List<RequestPojo> rest_List) {
        super(context, R.layout.view_service_center_adapter, rest_List);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.view_service_center_adapter, null, true);
...
//      Status Paid
        ...
        if (rest_List.get(position).getRqstStatus().trim().equals("REQUESTED")) {
            ...
            UFuelrqsted.setText(rest_List.get(position).getFuelRqstd());
...
//            UFuelRqstStatus.setTextColor(Color.parseColor(""));
            ...
            UFuelApvdRqst.setText(rest_List.get(position).getFuelRqstd());
