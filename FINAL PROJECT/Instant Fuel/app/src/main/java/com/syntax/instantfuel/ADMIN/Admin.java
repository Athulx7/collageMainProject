package com.syntax.instantfuel.ADMIN;
...
public class Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_verify_seller, R.id.nav_view_seller, R.id.nav_view_user, R.id.nav_view_complaints, R.id.nav_view_complaints_seller)
